...
type TechnicalRehearsalReportPrintProps = {
  reportId: number;
};

export default function TechnicalRehearsalReportPrint({
  reportId,
}: TechnicalRehearsalReportPrintProps) {
  ...
  useEffect(() => {
    async function loadReport() {
      ...
      if (error) {
        console.error(
          "Load rehearsal print report failed:",
          error
        );
        return;
      }
    ...
    <main className="min-h-screen bg-zinc-100 p-8 text-zinc-950 print:bg-white print:p-0">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-white shadow-2xl print:max-w-none print:rounded-none print:shadow-none">
        ...
        <div className="space-y-8 px-10 py-8 print:px-8">
          ...
          <PrintSection title="General Timings">
            <PrintRow
              label="Arrival Time"
          ...
          <PrintSection title="Act 1">
            ...
            <PrintRow
              label="FOH"
              value={report.act_1_sound_foh}
            />

            <PrintRow
              label="Box Office"
              value={report.act_1_sound_box_office}
            />

            <PrintRow
              label="Lake"
              value={report.act_1_sound_lake}
            />

            <PrintRow
              label="Cottages"
              value={report.act_1_sound_cottages}
            />

            <PrintRow
              label="Top Gate"
              value={report.act_1_sound_top_gate}
            />
          </PrintSection>
          ...
          <PrintSection title="Act 2">
            <PrintRow
              label="Start Time"
              value={report.rehearsal_act_2_start_time}
            />

            <PrintRow
              label="End Time"
              value={report.rehearsal_act_2_end_time}
            />
            ...
            <PrintRow
              label="FOH"
              value={report.act_2_sound_foh}
            />

            <PrintRow
              label="Box Office"
              value={report.act_2_sound_box_office}
            />

            <PrintRow
              label="Lake"
              value={report.act_2_sound_lake}
            />

            <PrintRow
              label="Cottages"
              value={report.act_2_sound_cottages}
            />

            <PrintRow
              label="Top Gate"
              value={report.act_2_sound_top_gate}
            />
          </PrintSection>
